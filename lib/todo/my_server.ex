defmodule Todo.MyServer do
  ...
  The following events may be emitted:
    ...
    * `[:todo, :my_server, :call, :start]` - Dispatched
    ...
    * `[:todo, :my_server, :call, :stop]` - Dispatched
    ...
    * `[:todo, :my_server, :call, :exception]` - Dispatched
